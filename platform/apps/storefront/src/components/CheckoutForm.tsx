    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <VStack align="stretch" gap={6}>
              ...
              <Grid templateColumns={{ base: '1fr', md: 'repeat(2, 1fr)' }} gap={4}>
                ...
                <GridItem colSpan={{ base: 1, md: 2 }}>
                  <Field.Root required invalid={!!errors.deliveryAddress?.municipality}>
                    ...
                    <Input
                      placeholder="Brussels"
                      {...register('deliveryAddress.municipality', { required: true })}
                    />
                  </Field.Root>
                </GridItem>
                <GridItem colSpan={{ base: 1, md: 2 }}>
                  <Field.Root>
                    ...
                    <Textarea
                      placeholder="Door code, floor, delivery notes..."
                      {...register('deliveryAddress.comment')}
                    />
                  </Field.Root>
                </GridItem>
              </Grid>
          ...
          <Grid templateColumns={{ base: '1fr', md: 'repeat(2, 1fr)' }} gap={4}>
            <GridItem colSpan={{ base: 1, md: 2 }}>
              <Field.Root required invalid={!!errors.billingInformation?.name}>
                ...
                <Input
                  ...
                  {...register('billingInformation.name', { required: true })}
                />
              </Field.Root>
            </GridItem>
            <GridItem>
            ...
            <GridItem>
              <Field.Root required invalid={!!errors.billingInformation?.phone}>
                ...
                <Input
                  placeholder="+32 ..."
                  {...register('billingInformation.phone', { required: true })}
                />
              </Field.Root>
            </GridItem>
          </Grid>
        ...
        <SectionCard
          ...
          title="Payment"
          description="Select the payment method supported by this establishment."
        >
          <Field.Root required>
